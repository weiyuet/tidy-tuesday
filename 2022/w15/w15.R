...
locations <- c("African Region", "European Region", "Region of the Americas", "South-East Asia Region", "Western Pacific Region", "G20", "OECD Countries")
...
indoor_pollution %>% 
  ...
  scale_y_continuous(labels = label_number(decimal.mark = ".", accuracy = 1),
                     breaks = seq(0, 20, 2)) +
  scale_colour_manual(values = natparks.pals("Banff")) +
  theme_classic() +
